...
public class AddListener implements ActionListener {
    ...
    public AddListener(String name, HumanWindow humanWindow) {
        this.name = name;
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        try {
            HumanBeing human = new HumanBeing((String) humanWindow.name.getValue(), new Coordinates((Float) humanWindow.coordinateX.getValue(),
                    (Float) humanWindow.coordinateY.getValue()),
                    (Boolean) humanWindow.realHero.isSelected(),
                    (Boolean) humanWindow.hasToothpick.isSelected(),
            ...
            humanWindow.context.sendRequest(name, new Argument(human));
